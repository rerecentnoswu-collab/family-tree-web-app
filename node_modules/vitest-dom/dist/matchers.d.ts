...
declare function toContainElement(
  element: Element,
  element: HTMLElement | SVGElement | null,
): MatcherResult;

declare function toContainHTML(
  element: Element,
  htmlText: string,
): MatcherResult;
...
declare function toHaveAccessibleName(
  text?: string | RegExp | typeof expect.stringContaining,
): MatcherResult;

declare function toHaveAttribute(
  element: Element,
  attr: string,
  value?: unknown,
): MatcherResult;

declare function toHaveClass(
  element: Element,
  ...classNames: string[]
): MatcherResult;

declare function toHaveStyle(
  element: Element,
